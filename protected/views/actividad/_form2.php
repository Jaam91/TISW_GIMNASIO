...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/js/actividad-instructor2.js', CClientScript::POS_END);?>

	<?php
    Yii::app()->getClientScript()->registerScript('nuevo_campo2',CClientScript::POS_END);
 	?>
