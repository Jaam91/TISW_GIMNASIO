...
/**
 * This is the model class for table "gestiona_dependencia".
 *
 * The followings are the available columns in table 'gestiona_dependencia':
 ...
 */
class GestionaDependencia extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('rut_administrador, id_dependencia, fecha, hora', 'required'),
			array('rut_administrador', 'length', 'max'=>10),
			array('id_dependencia', 'length', 'max'=>17),
			array('accion', 'length', 'max'=>12),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('rut_administrador, id_dependencia, fecha, hora, accion', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GestionaDependencia the static model class
	 */
